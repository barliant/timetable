...
def main():
  ...
  doc_name = interaktif('Spreadsheet name [Simulasi-Jadwal-2013-2014-1 (Responses)]: ')
  doc_name = contain_space(doc_name)

  '''
  sudah_mengisi = olahdata(username, passwd, doc_name)
...
def olahdata(username, passwd, doc_name):
  print 'Logging in ...'
